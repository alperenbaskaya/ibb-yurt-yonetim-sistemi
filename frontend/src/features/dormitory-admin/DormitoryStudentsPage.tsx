...
export function DormitoryStudentsPage() {
  ...
  const filteredStudents = useMemo(
    () => normalized
      ? students.filter((student) => `${student.firstName} ${student.lastName} ${student.email} ${student.identityNumber}`.toLocaleLowerCase('tr-TR').includes(normalized))
      : students,
    [normalized, students],
  )
